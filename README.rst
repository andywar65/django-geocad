...
This app is tested on Django (4.2 to 6.0) and Python (3.9 to 3.14). It
...
3.11, 3.12 versions. Tested for Django 5.2 on Python 3.13.1 and Django
6.0 on Python 3.14.2
